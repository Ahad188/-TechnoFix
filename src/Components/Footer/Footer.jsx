     ...
     <footer className="mt-12 bg-[#02033B] w-full">
      <div className="max-w-[1240px] mx-auto pt-12 px-6">
        <div className="flex flex-wrap md:justify-between">
          <div className="w-full md:w-[calc(33.333% - 20px)] mb-8 md:mb-0 md:mr-8">
          ...
          <div className="w-full md:w-[calc(33.333% - 20px)] mb-8 md:mb-0">
            <a href="#"><img className="border-b border-white pb-7 px-5" src={logo} alt="logo" /></a>
            <ul className="ml-5 mt-3">
              <li className="my-3"><a className="text-xl leading-[25px] font-bold text-[#FFC247]" href="#">iPhone</a></li>
              <li className="my-3"><a className="text-xl leading-[25px] font-bold text-[#FFC247]" href="#">Android</a></li>
              <li className="my-3"><a className="text-xl leading-[25px] font-bold text-[#FFC247]" href="#">Windows</a></li>
              <li className="my-3"><a className="text-xl leading-[25px] font-bold text-[#FFC247]" href="#">Help</a></li>
              <li className="my-3"><a className="text-xl leading-[25px] font-bold text-[#FFC247]" href="#">About</a></li>
              <li className="my-3"><a className="text-xl leading-[25px] font-bold text-[#FFC247]" href="#">Insights</a></li>
            </ul>
          </div>

          <div className="w-full md:w-[calc(33.333% - 20px)]">
            <div className="bg-[#FFC247] rounded-xl p-6 md:h-[232.39px]">
              ...
              <div className="flex">
                <input className="rounded p-2 mr-2" type="text" placeholder="Enter Email" />
